...
const aboutMd = `### Про реалізацію

Це пілотний запуск проекту, який містить мінімальний функціонал і йому ще не хватає багатьох можливостей, таких як:
* Авторизація читачів для складання списку побажань
* Швидка реєстрація інших власників книг
* Відгук та оцінка книги власником
* Перегляд детальної інформації про авторів книг
* Вибір способу сортування книг

В залежності від попиту проект буде розвиватись і далі.  
`;
